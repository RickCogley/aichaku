...
export function resolveProjectPath(userPath?: string): string {
  ...
  if (normalized.includes("..")) {
    throw new Error("Invalid project path: parent directory references not allowed");
  }
 ...
 */
export function validateProjectFile(filePath: string, projectPath: string): string {
